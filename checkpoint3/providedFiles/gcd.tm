...
* <- id
 33:     LD  1,-10(5)	op: load left
 34:    DIV  0,1,0	op /
* <- op
 35:     ST  0,-10(5)	op: push left
* -> id
* looking up id: v
 36:     LD  0, -3(5)	load id value
* <- id
 37:     LD  1,-10(5)	op: load left
 38:    MUL  0,1,0	op *
* <- op
 39:     LD  1, -9(5)	op: load left
 40:    SUB  0,1,0	op -
* <- op
...
* <- id
 66:     ST  0, -9(5)	store arg val
* -> id
* looking up id: y
 67:     LD  0,  0(6)	load id value
* <- id
 68:     ST  0,-10(5)	store arg val
 69:     ST  5, -7(5)	push ofp
 70:    LDA  5, -7(5)	push frame
 71:    LDA  0,  1(7)	load ac with ret ptr
 72:    LDA  7,-61(7)	jump to fun loc
 73:     LD  5,  0(5)	pop frame
* <- call
 74:     ST  0, -6(5)	store arg val
